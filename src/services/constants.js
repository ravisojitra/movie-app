...
export const FETCH_TRENDING_URL = "https://api.themoviedb.org/3/trending/all/week?api_key=${API_KEY}";
export const FETCH_TOP_RATED_URL = "https://api.themoviedb.org/3movie/top_rated?api_key=${API_KEY}&language=en-US&page=1";
